...
// 方法论：传统紫微斗数体系
//
//   星盘计算 → iztro (https://github.com/iztro/iztro) v2.4.8
//     npm 包封装传统紫微斗数排盘，基于《紫微斗数全书》
//   星曜特性、宫位解读 → 《紫微斗数全书》（宋代陈希夷）
//   四化（禄权科忌）→ 同上，卷三·四化曜
//   十二宫位 → 同上，卷一·十二宫论
//
// ⚠ 开发者合成：
//   - 星曜颜色分类（gold/jade/cinnabar/ice/purple/gray/white）
//     为前端数据可视化设计，非经典分类体系
//   - BRANCH_TO_ANGLE 天星图角度映射 → 工程定义
//     （经典紫微无"天星图"可视化传统）
// ═══════════════════════════════════════════════════════════════
