// ============================================================
// constants/yijing-data.ts — Trigram, Palace, Na Jia, Wuxing,
// Six Spirits data for 六爻 (Yijing).
// Split from constants/yijing.ts (original single file was 722
// lines). This file contains all non-hexagram static data.
// ============================================================
