...
export const EVENT_TYPES: Record<string, { name: string; icon: string; keywords: string[] }> = {
  wedding: {
    name: '嫁娶',
    icon: '婚',
    keywords: ['嫁娶', '结婚', '婚嫁', '订婚', '纳采', '纳征', '嫁', '娶', '婚'],
  },
  opening: {
    name: '开业',
    icon: '业',
    keywords: ['开业', '开市', '开张', '交易', '立券', '纳财', '开市', '挂匾'],
  },
  moving: {
    name: '搬家',
    icon: '宅',
    keywords: ['搬家', '移徙', '入宅', '迁居', '移居', '入宅', '迁移'],
  },
  travel: { name: '出行', icon: '行', keywords: ['出行', '远行', '旅游', '出行', '远行'] },
  construction: {
    name: '修造',
    icon: '造',
    keywords: ['修造', '动土', '装修', '开工', '修造', '动土', '破土', '安门', '起基', '上梁'],
  },
  burial: {
    name: '安葬',
    icon: '葬',
    keywords: ['安葬', '下葬', '入土', '安葬', '入殓', '移柩', '除服', '成服', '修坟', '立碑'],
  },
  sacrifice: {
    name: '祭祀',
    icon: '祀',
    keywords: ['祭祀', '祈福', '酬神', '祭祀', '斋醮', '祈福', '酬神', '求嗣', '沐佛', '设醮'],
  },
  meeting: { name: '会友', icon: '友', keywords: ['会友', '会友', '交友', '订盟'] },
  medical: {
    name: '求医',
    icon: '医',
    keywords: ['求医', '治病', '看病', '求医', '治病', '疗病', '针灸'],
  },
