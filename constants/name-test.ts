...
// 方法论：五格剖象法（熊崎健翁式）
//
//   五格剖象体系 → 熊崎健翁（Kumatani Ken'ō, 1881-1965）
//     日本大正-昭和期姓名学家，融合中国易学五行与日本传统姓名学
//     核心著作《姓名学の極意》（1934）奠定五格剖象法体系
//     五格定义（天格/人格/地格/总格/外格）及笔画取法均出自此书
//   81 数理吉凶表 → 同上，熊崎健翁《姓名学》
//     数理 1-81 的吉凶分类、命名与含义文本
//   三才配置五行生克 → 《易经》五行生克原理
//     天格/人格/地格之间的五行相生/相克/比和判断
//   汉字笔画 → 康熙字典笔画规范（《康熙字典》）
//     通过 makemeahanzi 开源笔画数据库实现笔画查询
//     (https://github.com/skishore/makemeahanzi, ~9565 字)
//
// 评分算法：
//   五格各 20 分（吉=20 / 半吉=10 / 凶=0）+ 人格双倍权重(+20)
//   + 三才配置 20 分（吉=20 / 半吉=8 / 凶=0）
//   总分 0-100，阈值：≥80 大吉 / ≥60 中吉 / ≥40 末吉 / <40 凶
//
// ⚠ 开发者合成：
//   - 分数权重和三才分值分配（熊崎原典有吉凶判定但无百分比量化）
//   - 评分阈值划分（≥80/60/40 为现代工程校准）
//   - 数理分类标签（首领运/财富运/才能运等）为现代实用分类整理
//     非熊崎原典的严格分类体系
// ═══════════════════════════════════════════════════════════════
...
export const NUMBERS_81: NumberMeaning[] = [
  ...
  { number: 8, fortune: '半吉', name: '八卦之数', meaning: '智谋超群，财利丰盈，功名可望。' },
  ...
  { number: 17, fortune: '半吉', name: '刚强之数', meaning: '权威刚强，突破万难，可成大业。' },
  { number: 18, fortune: '半吉', name: '有志竟成', meaning: '有志竟成，智勇双全，排除万难。' },
  {
    number: 19,
    fortune: '凶',
    name: '风云蔽月',
  ...
  { number: 25, fortune: '半吉', name: '英俊之数', meaning: '资性英敏，刚毅果断，可成伟业。' },
  ...
  { number: 30, fortune: '半吉', name: '浮沉不定', meaning: '浮沉不定，吉凶难分，好运不长。' },
  ...
  { number: 36, fortune: '半吉', name: '波澜重叠', meaning: '波澜重叠，沉浮万状，侠肝义胆。' },
  ...
  { number: 49, fortune: '半吉', name: '吉凶难分', meaning: '吉凶难分，利害混集，须防大厄。' },
  { number: 50, fortune: '半吉', name: '船行险滩', meaning: '一成一败，吉凶参半，万事难周全。' },
  { number: 51, fortune: '半吉', name: '盛衰交加', meaning: '盛衰交加，波澜重叠，沉浮不定。' },
  ...
  { number: 55, fortune: '半吉', name: '善恶之数', meaning: '善善恶恶，吉凶参半，须防投机。' },
  { number: 56, fortune: '凶', name: '浪里行舟', meaning: '浪里行舟，历尽艰辛，失败多端。' },
  { number: 57, fortune: '吉', name: '日照春松', meaning: '寒雪青松，夜莺啼春，福禄并至。' },
  { number: 58, fortune: '半吉', name: '晚行遇月', meaning: '晚行遇月，先苦后甘，宽宏扬名。' },
  ...
  { number: 70, fortune: '凶', name: '弃世之数', meaning: '废弃之数，命运多舛，险恶亡身。' },
  {
    ...
    fortune: '半吉',
    name: '吉凶参半',
    meaning: '吉凶参半，缺乏耐久，劳而无功。守正则可得半吉。',
  },
  { number: 72, fortune: '凶', name: '劳苦之数', meaning: '劳苦之数，阴云蔽月，志望难达。' },
  {
    ...
    fortune: '半吉',
    name: '无勇之数',
    meaning: '盛衰交加，徒有高志，难成大事。需外力扶持方可。',
  },
