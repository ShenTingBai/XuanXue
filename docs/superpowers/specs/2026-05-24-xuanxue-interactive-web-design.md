...
- **第 1 批（Quick Wins）**：生肖太岁关系展示、月亮星座、流年签
- **第 2 批（低成本高价值）**：化太岁、同年肖区分、本命佛
- **第 3 批（核心新功能）**：八字合婚、姓名测试（五格剖象）
- **第 4 批（引擎强化）**：八字引擎增强、紫微补齐、星座星盘、配对解释
- **第 5 批（意境 + 复杂）**：测字占卜、月运、用户系统增强、导出分享、择吉日
